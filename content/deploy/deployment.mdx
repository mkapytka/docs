...
Please provide this information to **repository systems specialists** ([nrp.repozitare@eosc.cz](mailto:nrp.repozitare@eosc.cz)).

After VO is created, you will be able to manage it as described in [CESNET Invenio AAI guide](https://nrp-cz.github.io/docs/deploy/aai). 
...
[cesnet-invenio@eosc.cz](mailto:cesnet-invenio@eosc.cz)
